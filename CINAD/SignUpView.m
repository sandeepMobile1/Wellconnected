...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    if (self == [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        ...
        self.tabBarItem = [[[UITabBarItem alloc] initWithTitle:@"Sign up"
...
- (void)viewDidLoad
{
    ...
    webView = [[UIWebView alloc] initWithFrame: CGRectMake(0, rect.origin.y-20, rect.size.width,rect.size.height-60) ];
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:   [[NSUserDefaults standardUserDefaults] objectForKey:@"signupUrl" ]   ]];
