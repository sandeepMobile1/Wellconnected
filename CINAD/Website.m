...
- (void)viewDidLoad
{
 ...
 //   CGRect rect =   [UIScreen mainScreen].applicationFrame ;
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:   [[NSUserDefaults standardUserDefaults] objectForKey:@"websiteUrl" ]   ]];
...
{ 
	static Website* sharedController;
	static UINavigationController *navigationController;
 	if(!sharedController)
	{
		sharedController = [[Website alloc]  initWithNibName:nil bundle:nil ];
